...
The code sample present in \ref{lst:home-screen-accessibility} shows the key accessibility properties implemented in the Home screen.
...
\begin{enumerate}
    \item \textbf{Touch target sizing}: All interactive elements maintain minimum dimensions of 48$\times$48, exceeding the WCAG 2.5.8 requirement of 24$\times$24px and addressing the mobile-specific need for larger touch targets;
...
\subsection{Best practices main screen (TO REMOVE)}
...
\subsection{Accessibility tools screen (TO REMOVE)}
...
\subsection{Instruction and community screen (TO REMOVE)}
