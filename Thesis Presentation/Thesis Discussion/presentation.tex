...
% Code highlighting setup for accessibility examples
\lstset{
    ...
    language={},
    morekeywords={TouchableOpacity,accessibilityRole,accessibilityLabel,accessibilityHint,onPress,Text,Semantics,label,button,onTap,child,ElevatedButton,onPressed}
}

% Define emptyframe environment
...
% Empty frame for clean transition
\begin{emptyframe}
    \begin{center}
        \Huge Thank You
